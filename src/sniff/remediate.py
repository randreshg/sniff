...
sniff provides these types. Consumers implement them.
sniff itself never imports or executes any implementation.
"""
...
class DetectedIssue:
    ...
    This is the bridge between detection (pure sniff) and remediation (consumer code).
    """
